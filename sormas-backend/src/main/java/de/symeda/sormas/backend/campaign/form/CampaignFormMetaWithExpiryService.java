...
@Stateless
@LocalBean
public class CampaignFormMetaWithExpiryService extends AdoServiceWithUserFilter<CampaignFormMetaExpDay> {

	public CampaignFormMetaWithExpiryService() {
		super(CampaignFormMetaExpDay.class);
	}

	@SuppressWarnings("rawtypes")
	@Override
	public Predicate createUserFilter(CriteriaBuilder cb, CriteriaQuery cq, From<?, CampaignFormMetaExpDay> from) {
		return null;
	}
	...
	public List<CampaignFormMetaExpDay> getAllAfter(Date since, User user) {

		CriteriaBuilder cb = em.getCriteriaBuilder();
		CriteriaQuery<CampaignFormMetaExpDay> cq = cb.createQuery(getElementClass());
		Root<CampaignFormMetaExpDay> root = cq.from(getElementClass());
		...
		List<CampaignFormMetaExpDay> resultList = em.createQuery(cq).getResultList();
		return resultList;
	}

//	public List<CampaignFormMetaExpDay> getAllFormElements(User user) {
//
//		CriteriaBuilder cb = em.getCriteriaBuilder();
//		CriteriaQuery<CampaignFormMetaExpDay> cq = cb.createQuery(getElementClass());
//		Root<CampaignFormMetaExpDay> root = cq.from(getElementClass());

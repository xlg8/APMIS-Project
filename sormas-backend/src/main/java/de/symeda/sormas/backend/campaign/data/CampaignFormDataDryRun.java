...
@Entity(name = "campaignFormDataDryRun")
@Audited
public class CampaignFormDataDryRun extends AbstractDomainObject{

	public static final String TABLE_NAME = "campaignFormDataDryRun";

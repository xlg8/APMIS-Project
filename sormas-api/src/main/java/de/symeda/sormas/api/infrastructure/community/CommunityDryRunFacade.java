...
public interface CommunityDryRunFacade extends GeoLocationFacade<CommunityDryRunDto, CommunityDryRunDto, CommunityReferenceDto, CommunityCriteriaNew> {
	...
	Page<CommunityDryRunDto> getIndexPage(CommunityCriteriaNew communityCriteria, Integer offset, Integer size, List<SortProperty> sortProperties);
	...
	List<CommunityDryRunDto> getAllAfterWithDistrict(Date date, Set<DistrictReferenceDto> rDistdto);

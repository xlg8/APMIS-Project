...
//	private String externalIddummy;
	...
	public DistrictHistoryExtractDto(String uuid, String name, Boolean archived, Long externalID, LocalDateTime startDate, LocalDateTime endDate) {
	    this.uuid_ = uuid;
	    this.name = name;
    ...
    public DistrictHistoryExtractDto(String string, String string2, Boolean boolean1, long l, LocalDateTime localDateTime, Object object) {
        this.uuid_ = string;
        this.name = string2;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DistrictHistoryExtractDto other = (DistrictHistoryExtractDto) obj;
	...
	@Override
	public int compareTo(DistrictHistoryExtractDto o) {

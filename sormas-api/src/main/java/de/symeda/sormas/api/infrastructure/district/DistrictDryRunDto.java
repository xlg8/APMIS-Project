...
public class DistrictDryRunDto extends EntityDto {
...
//	public static final String DISTRICT_MODALITY = "districtModality";
	...
	public DistrictDryRunDto(String name, Long populationData, Long regionId, String regionUuid_, String uuid_, String selectedPopulationData) {
		this.name = name;
	...
	public DistrictDryRunDto(String name, Long populationData, Long regionId, String regionUuid_, String uuid_, String selectedPopulationData, String districtModality, String districtStatus, String ageGroup) {
		this.name = name;
		this.populationData = populationData;
		this.regionId = regionId;
		this.regionUuid_ = regionUuid_;
	...
	public DistrictDryRunDto(String name, Long populationData, Long populationData5_10, Long regionId, String regionUuid_, String uuid_, String selectedPopulationData, String districtModality, String districtStatus) {
		this.name = name;
		this.populationData = populationData;
...
//		this.ageGroup = ageGroup;
	...
	public DistrictDryRunDto(@Size(max = 255, message = "textTooLong") String name, String mapHasc) {
		super();
		this.name = name;
	...
	public static DistrictDryRunDto build() {

...
@Remote
public interface DistrictDryRunFacade extends GeoLocationFacade<DistrictDryRunDto, DistrictIndexDto, DistrictReferenceDto, DistrictCriteria> {
	...
	DistrictDryRunDto getDistrictByUuid(String uuid);

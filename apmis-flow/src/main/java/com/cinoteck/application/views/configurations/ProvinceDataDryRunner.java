 ...
 */
public class ProvinceDataDryRunner extends DataImporter {

	private static final Logger LOGGER = LoggerFactory.getLogger(ProvinceDataDryRunner.class);
	...
	public ProvinceDataDryRunner(File inputFile, boolean hasEntityClassRow, RegionDto currentUser,

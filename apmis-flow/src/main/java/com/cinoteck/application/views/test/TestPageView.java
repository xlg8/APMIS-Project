...
//			this.setColspan(layoutParent, 2);
			...
			CampaignFormGridComponentx comp = new CampaignFormGridComponentx(
...
//			tab2.setCaption("Pre Campaign Dashboard");
			...
			CampaignFormGridComponent compp = new CampaignFormGridComponent(this.campaignDto == null ? Collections.EMPTY_LIST
...
//			this.setColspan(actionButtons, 2);
			...
			saveChanges.addClickListener(e->{
			  ...
			  Button spacer = new Button();
		        ...
		        actionButtonsLayout.add(archiveDearchive, publishUnpublishCampaign, openCloseCampaign, duplicateCampaign, deleteCampaign, spacer, discardChanges, saveChanges);
		        ...
		        formLayout.add(camapaignBasics, hort, campaignName, round, startDate, endDate, description, layoutParent, actionButtonsLayout); // ,
																															// layoutParent,
...
////			this.setColspan(actionButtons, 2);
//
////			dialog.getFooter().add(actionButtons);
//		}
...
//			System.out.println(areas + "areassssssssssssssssssssssssssssssssssssssssssssss");
			List<AreaDto> areas = FacadeProvider.getAreaFacade().getAllActiveAsReferenceAndPopulation(campaignDto);
//			System.out.println(areas + "areassssssssssssssssssssssssssssssssssssssssssssss");

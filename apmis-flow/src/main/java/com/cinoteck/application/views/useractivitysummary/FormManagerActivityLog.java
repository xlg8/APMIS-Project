...
public class FormManagerActivityLog extends VerticalLayout implements RouterLayout {
	...
	public FormManagerActivityLog() {
		setSizeFull();
		setHeightFull();
		addFilters();
		confiureFormManagerActivityGrid();
	}
	...
	public void confiureFormManagerActivityGrid() {
		...
		List<UserActivitySummaryDto> userActivityList = FacadeProvider.getUserFacade().getUsersActivityByModule("Form Manager");
		...
		exportFileName = "Form_Manager_Report_"

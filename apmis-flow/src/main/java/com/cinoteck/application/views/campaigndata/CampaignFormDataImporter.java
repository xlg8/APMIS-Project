...
public class CampaignFormDataImporter extends DataImporter {
	...
	//file_, true, userDto, campaignForm.getUuid(), campaignReferenceDto, ValueSeparator.COMMA
	...
	@Override
	public void startImport(Consumer<StreamResource> addErrorReportToLayoutCallback, Consumer<StreamResource> notused, boolean notUsed, UI currentUI, boolean duplicatesPossible)

...
//        final AreaReferenceDto userArea = user.getCurrent().getUser().getArea();
//        final RegionReferenceDto userRegion = user.getCurrent().getUser().getRegion();
//        final DistrictReferenceDto userDistrict = user.getCurrent().getUser().getDistrict();
//        if (userArea != null) {
